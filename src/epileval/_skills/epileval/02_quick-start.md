...
```python
from epileval import forecasting, AlarmPolicy
...
```python
import scitex
scitex.epileval.detection.evaluate(...)   # same object as epileval.detection
```
