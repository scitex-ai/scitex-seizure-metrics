"""Smoke test for papers.kuhlmann2018.metrics()."""
import numpy as np
from scitex_seizure_metrics.papers import kuhlmann2018
...
def test_kuhlmann2018_returns_dict_out_is_dict():
    # Arrange
    y, p, t, sz = _data()
    if "kuhlmann2018" == "kuhlmann2018":
        out = kuhlmann2018.metrics(y_true=y, y_proba=p)
    else:
        out = kuhlmann2018.metrics(y_true=y, y_proba=p, times_seconds=t,
...
def test_kuhlmann2018_returns_dict_paper_in_out():
    # Arrange
    y, p, t, sz = _data()
    if "kuhlmann2018" == "kuhlmann2018":
        out = kuhlmann2018.metrics(y_true=y, y_proba=p)
