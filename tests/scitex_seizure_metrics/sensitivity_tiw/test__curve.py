"""Tests for ``sensitivity_tiw._curve`` — the empirical curve + envelope.

Covers ``sensitivity_tiw_curve``, the ``SensitivityTiWCurve`` container,
and ``monotone_upper_envelope`` against synthetic data with KNOWN ground
truth. We assert the summary scalars + monotonicity, mirroring the
package's flat, one-assertion-per-test convention.
"""
...
# --------------------------------------------------------------------------
# Random predictor -> on the diagonal
# --------------------------------------------------------------------------
