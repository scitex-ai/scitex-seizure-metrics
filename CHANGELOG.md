...
### Added
- 3 more paper-replica shims: `papers.cook2013` (Snyder traffic-light reporting), `papers.proix2021` (multi-horizon multidien IoC at 1h/1d/3d), `papers.stirling2021` (sub-scalp detection AUC + circadian-baseline IoC).
- Per-shim test files mirroring src layout (PS204 compliance).
